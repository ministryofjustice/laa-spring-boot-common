...
//    HttpServletRequest request = mock(HttpServletRequest.class);
//    HttpServletResponse response = mock(HttpServletResponse.class);
//    Cookie consentCookie = new Cookie("cookies_policy", "{\"analytics\":true}");
//    Object handler = new Object();
//    when(request.getRequestURI()).thenReturn("/home");
...
//    HttpServletResponse response = mock(HttpServletResponse.class);
//    Cookie consentCookie = new Cookie("cookies_policy", "{\"analytics\":true}");
//    Cookie sessionCookie = new Cookie("JSESSIONID", "123");
//    Object handler = new Object();
//    when(request.getRequestURI()).thenReturn("/home");
...
//    HttpServletRequest request = mock(HttpServletRequest.class);
//    HttpServletResponse response = mock(HttpServletResponse.class);
//    Cookie malformedCookie = new Cookie("cookies_policy", "not-json");
//    Object handler = new Object();
//    when(request.getRequestURI()).thenReturn("/home");
